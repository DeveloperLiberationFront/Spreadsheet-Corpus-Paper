...
%TODO This figure isn't perfect. Improvements:
%		Representative set (Sets Z and D) should actually be representative, not random.
%		Coverage calculation should be correct
%		Set C is mysteriousy missing from this explanation (Emerson guesses it'll be useful later)
%		Some points are duplicates (e.g., circles in Set C)
%		lighten up axes lines
