...
Other corpora out there (mostly the seeded error ones).

Maybe mention some other large corpora for general software.
...
differ mostly in the intent of the approach.
Nagappan and colleagues' approach is designed to allow researchers to
(a) select a subset of software projects in a universe of projects,
such that the subset is representative of the universe,
and (b) compare how well a given set of projects represents
the universe.
In contrast, our approach is designed to allow researchers to 
select select a subset of a universe such that the subset represents
a sample, perhaps closed-source, set.
%This is depicted graphically in figure\ldots
